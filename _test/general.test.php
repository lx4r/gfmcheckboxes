<?php
/**
 * General tests for the gfmcheckboxes plugin
 *
...
class general_plugin_gfmcheckboxes_test extends DokuWikiTest {
    ...
    public function test_plugininfo() {
        ...
        $this->assertEquals('gfmcheckboxes', $info['base']);
    ...
    /**
     * Simple test to make sure unchecked checkboxes are rendered correctly
     */
    public function test_unchecked_checkboxes() {
        $info = array();
